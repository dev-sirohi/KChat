...
class MessageAdapter(val context: Context, private val messageList: ArrayList<com.example.kchat.Message>) :
    ...
    class ReceivedViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val recivedMessage = itemView.findViewById<TextView>(R.id.txtReceivedMessage)
